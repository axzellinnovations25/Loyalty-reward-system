...
const { createSchema, updateSchema, assignPlanSchema, validateBody } = require('./shops.validator');
...
router.post('/:id/plan',     validateBody(assignPlanSchema), controller.assignPlan);
