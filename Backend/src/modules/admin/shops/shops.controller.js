...
const assignPlan = async (req, res, next) => { try { return ok(res, await service.assignPlan(req.params.id, req.body.planId, req.body.note, req.admin?.adminId)); } catch (e) { next(e); } };
