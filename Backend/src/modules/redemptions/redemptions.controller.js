...
const service = require('./redemptions.service');
...
const create  = async (req, res, next) => { try { return created(res, await service.create(req.shopId, req.user.id, req.body)); } catch (e) { next(e); } };
